...
const faqData = [
    {
        question: 'Apa itu GezyHost?',
        answer: '<ul>GezyHost adalah penyedia layanan hosting terkemuka yang berfokus pada panel Pterodactyl untuk server game dan aplikasi. Kami menawarkan hosting berkualitas premium dengan harga terjangkau dan performa optimal.</ul>'
    },
    {
        question: 'Bagaimana cara membeli hosting di GezyHost?',
        answer: '<ul>Untuk membeli hosting, Anda perlu mengisi "Informasi Akun" Anda, memilih "Paket Hosting" yang diinginkan, memilih "Metode Pembayaran" (QRIS, Gopay, atau DANA), lalu memeriksa "Ringkasan Pesanan". Setelah itu, klik tombol "BELI" untuk melanjutkan konfirmasi pembayaran dan aktivasi layanan melalui WhatsApp Admin GezyHost.</ul>'
    },
    {
    ...
    {
        question: 'Apakah GezyHost menyediakan layanan support?',
